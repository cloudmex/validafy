...
export default function Landing() {
  ...
  const onSubmit = (e) => {
    ...
    ipfs.add(initialBc.buffer).then((result) => {
      sm.contr.methods
                    ...
                    <div className="text-white p-3 text-left  bg-blue-400">
                      <ul className="list-reset flex border-b">
                        <li className="-mb-px mr-1">
                          <a
                            className="bg-blue inline-block border-l border-t border-r rounded-t py-2 px-4 text-blue-dark font-semibold"
                            href="#"
                          >
                            Valida
                          </a>
                        ...
                        <li className="mr-1">
                          <a
                            className="bg-blue inline-block py-2 px-4 text-blue hover:text-blue-darker font-semibold"
                            href="#"
                            onClick={alert}
                          >
                            Estampa

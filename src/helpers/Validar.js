...
export default async (event,unhideCharge,Web3,wait,window,sameNetwork,initialBc,setInitialBc,addNetwork,ValidafySM,ipfs,setShowModal) => {

    
    // console.log( ValidafySM, "<= Este el WINDOW");
